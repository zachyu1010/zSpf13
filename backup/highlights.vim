...
function! s:MatchToggle()
  if exists('g:match_maps') && g:match_maps
    ...
    nnoremap <silent> <Leader>h1 :<C-U>call <SID>DoHighlight(1, 2, v:count)<CR>
    nnoremap <silent> <Leader>h2 :<C-U>call <SID>DoHighlight(2, 2, v:count)<CR>
    nnoremap <silent> <Leader>h3 :<C-U>call <SID>DoHighlight(3, 2, v:count)<CR>
    nnoremap <silent> <Leader>h4 :<C-U>call <SID>DoHighlight(4, 2, v:count)<CR>
    nnoremap <silent> <Leader>h5 :<C-U>call <SID>DoHighlight(5, 2, v:count)<CR>
    nnoremap <silent> <Leader>hq :<C-U>call <SID>DoHighlight(6, 2, v:count)<CR>
    nnoremap <silent> <Leader>hw :<C-U>call <SID>DoHighlight(7, 2, v:count)<CR>
    nnoremap <silent> <Leader>he :<C-U>call <SID>DoHighlight(8, 2, v:count)<CR>
    nnoremap <silent> <Leader>hr :<C-U>call <SID>DoHighlight(9, 2, v:count)<CR>
    nnoremap <silent> <Leader>ht :<C-U>call <SID>DoHighlight(10, 2, v:count)<CR>
    nnoremap <silent> <Leader>ha :<C-U>call <SID>DoHighlight(11, 2, v:count)<CR>
    nnoremap <silent> <Leader>hs :<C-U>call <SID>DoHighlight(12, 2, v:count)<CR>
    nnoremap <silent> <Leader>hd :<C-U>call <SID>DoHighlight(13, 2, v:count)<CR>
    nnoremap <silent> <Leader>hf :<C-U>call <SID>DoHighlight(14, 2, v:count)<CR>
    nnoremap <silent> <Leader>hg :<C-U>call <SID>DoHighlight(15, 2, v:count)<CR>
    nnoremap <silent> <Leader>h0 :<C-U>call <SID>UndoHighlight(2)<CR>
  endif
