...
function! s:MatchToggle()
  if exists('g:match_maps') && g:match_maps
    ...
    nnoremap <silent> <Leader>h1 :<C-U>call <SID>DoHighlight(4, 2, v:count)<CR>
    nnoremap <silent> <Leader>h2 :<C-U>call <SID>DoHighlight(5, 2, v:count)<CR>
    nnoremap <silent> <Leader>h3 :<C-U>call <SID>DoHighlight(6, 2, v:count)<CR>
    nnoremap <silent> <Leader>h4 :<C-U>call <SID>DoHighlight(7, 2, v:count)<CR>
    nnoremap <silent> <Leader>h5 :<C-U>call <SID>DoHighlight(8, 2, v:count)<CR>
    nnoremap <silent> <Leader>h6 :<C-U>call <SID>DoHighlight(9, 2, v:count)<CR>
    nnoremap <silent> <Leader>h7 :<C-U>call <SID>DoHighlight(11, 2, v:count)<CR>
    nnoremap <silent> <Leader>h8 :<C-U>call <SID>DoHighlight(12, 2, v:count)<CR>
    nnoremap <silent> <Leader>h9 :<C-U>call <SID>DoHighlight(13, 2, v:count)<CR>
